...
* ==============================================================================
* Input: HRS Exit files for 2002-2020
...
foreach y of local waves {
  ...
  use `hp_exit_`y'', clear
  merge m:1 HHID PN using `r_exit_`y''
    keep if _merge==3 // keep every HP
    drop _merge
    isid HHID PN OPN
  merge 1:1 HHID PN OPN using `mc_r_`y''
    drop _merge
    isid HHID PN OPN, missok
...
args variable x4_diffname c resident_mc
  ...
  gen `variable'`c'_son = 0 if inrange(`variable'M1`c',0,997) | inrange(`variable'M2`c',0,997) | inrange(`variable'M3`c',0,997) | inrange(`variable'M4`c',0,997) | inrange(`variable'M5`c',0,997)
  replace `variable'`c'_son = 1 if (X061_MC==3) & (OPN==`variable'M1`c' | OPN==`variable'M2`c' | OPN==`variable'M3`c' | OPN==`variable'M4`c' | OPN==`variable'M5`c')
  replace `variable'`c'_son = 1 if (X061_MC==3) & (`variable'M1`c'==993 | `variable'M2`c'==993 | `variable'M3`c'==993 | `variable'M4`c'==993 | `variable'M5`c'==993)
    if "`variable'"=="E013" { // add resident children
      replace `variable'`c'_son = 1 if X061_MC==3 & X056_MC==1
    }
    if "`variable'"=="T004" { // add will condition - ALL CHILDREN - "EQUALLY" NOT MENTIONED
      replace `variable'`c'_son = 1 if (X061_MC==3) & (`variable'M1`c'==996 | `variable'M2`c'==996 | `variable'M3`c'==996 | `variable'M4`c'==996 | `variable'M5`c'==996)
    }

  gen `variable'`c'_daughter = 0 if inrange(`variable'M1`c',0,997) | inrange(`variable'M2`c',0,997) | inrange(`variable'M3`c',0,997) | inrange(`variable'M4`c',0,997) | inrange(`variable'M5`c',0,997)
  replace `variable'`c'_daughter = 1 if (X061_MC==6) & (OPN==`variable'M1`c' | OPN==`variable'M2`c' | OPN==`variable'M3`c' | OPN==`variable'M4`c' | OPN==`variable'M5`c')
  replace `variable'`c'_daughter = 1 if (X061_MC==6) & (`variable'M1`c'==993 | `variable'M2`c'==993 | `variable'M3`c'==993 | `variable'M4`c'==993 | `variable'M5`c'==993)
    if "`variable'"=="E013" { // add resident children
      replace `variable'`c'_daughter = 1 if X061_MC==6 & X056_MC==1
    }
    if "`variable'"=="T004" { // add will condition - ALL CHILDREN - "EQUALLY" NOT MENTIONED
      replace `variable'`c'_daughter = 1 if (X061_MC==6) & (`variable'M1`c'==996 | `variable'M2`c'==996 | `variable'M3`c'==996 | `variable'M4`c'==996 | `variable'M5`c'==996)
    }
  ...
  replace `variable'`c'_child = 1 if `variable'`c'_son==1 | `variable'`c'_daughter==1

  egen `variable'`c'_r_nchild = sum(`variable'`c'_child), by(HHID PN) missing
  egen `variable'`c'_r_nson = sum(`variable'`c'_son), by(HHID PN) missing
  egen `variable'`c'_r_ndaughter = sum(`variable'`c'_daughter), by(HHID PN) missing
...
// ORGANIZE DATA
order xyear xwave HHID PN OPN SUBHH
sort xyear HHID PN OPN

save "$output/hrs_helper_v3-4_exitonly_revised", replace
* ==============================================================================
